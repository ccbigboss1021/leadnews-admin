<template>
  <div>
    ...
    <Editor ref="editor" :fileds="fileds" title="用户详情" :table="this.params.name" :submitSuccess="submitSuccess"/>
  </div>
</template>
  ...
  data () {
    return {
      ...
      fileds: [
        ...
        { list: true, label: '账号状态', name: 'status', type: 'radio', value: 0, radios: [{ value: 0, label: '正常' }, { value: 1, label: '冻结' }] },
